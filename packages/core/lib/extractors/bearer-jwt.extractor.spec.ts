...
describe("BearerJwtExtractor", () => {
  ...
  describe("hasAuthenticationInfo", () => {
    ...
    it.each([
      ...
      "should return false when authorization header is %s",
      (_, authValue) => {
  ...
  describe("getAuthorizationToken", () => {
    it.each([
      ...
      [
        "WebSocket request",
        { handshake: { headers: { authorization: "Bearer token456" } } },
        "token456",
      ],
      [
        "without Bearer prefix",
        { headers: { authorization: "token789" } },
        "token789",
      ],
      [
    ...
    it.each([
      ...
      [
        "no authorization header in WebSocket request",
        { handshake: { headers: {} } },
      ],
