export const metadata = {
  ...
  description: 'Learn how to access authenticated user information using CognitoUser decorators with type safety in NestJS-Cognito.',
}

# CognitoUser Decorators

Learn how to access authenticated user information in your NestJS application using the Cognito user decorators with built-in type safety.
...
- `@CognitoAccessUser` - Specialized decorator for access tokens with type safety
- `@CognitoIdUser` - Specialized decorator for ID tokens with type safety
...
For access tokens, use `@CognitoAccessUser` for better type safety:
...
For ID tokens, use `@CognitoIdUser` for better type safety:
